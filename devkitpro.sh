...
DEFAULT_ARM7_URL="http://downloads.sourceforge.net/project/devkitpro/default%20arm7/default_arm7-0.5.16.tar.bz2"
PALIB_URL="http://palib-dev.com/PAlib100707.7z"
LIBNDS_URL="http://downloads.sourceforge.net/project/devkitpro/libnds/libnds-1.4.6.tar.bz2"
